...
;;; Downloaded from http://www.cpm.z80.de/download/cpm2-asm.zip
;;; Changed 4 occurrences of ",M" to ",(HL)" -- E. Hazen 10/9/21
;
;   Set memory limit here. This is the amount of contigeous
; ram starting from 0000. CP/M will reside at the end of this space.
;
MEM	EQU	20		;for a 62k system (TS802 TEST - WORKS OK).
;
...
sectrn:equ  bios+48	;sector translate
